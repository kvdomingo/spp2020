...
\begin{enumerate}
	...
	\item
		\begin{enumerate}
			\item \textbf{Please incorporate changes that you mentioned in your reply to the reviewer but was not added to the manuscript. For example, add the conversion table from number to qualitative description -- "slightly below average".}
			
			We have added Table 1 in Sec.~2.4 for the conversion of PESQ from quantitative to qualitative. In the preceding paragraph, the following sentence has been added:
			
			\begin{quotation}
				...models the obsolete mean opinion scores (MOS). \textcolor{Green}{Its output is a float in the range $[1, 5]$ with corresponding qualitative descriptions at integer values, as shown in Table~1.}
			\end{quotation}
		\end{enumerate}
\end{enumerate}
